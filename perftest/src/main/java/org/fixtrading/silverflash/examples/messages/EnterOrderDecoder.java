...
public class EnterOrderDecoder {
  ...
  public EnterOrderDecoder wrap(final DirectBuffer buffer, final int offset,
  ...
  public Side side() {
    return Side.get(CodecUtil.charGet(buffer, offset + 14));
  }
  ...
  public long orderQty() {
    return CodecUtil.uint32Get(buffer, offset + 15, java.nio.ByteOrder.LITTLE_ENDIAN);
  }
  ...
  public long expireTime() {
    return CodecUtil.uint32Get(buffer, offset + 31, java.nio.ByteOrder.LITTLE_ENDIAN);
  }
  ...
  public Display display() {
    return Display.get(CodecUtil.uint8Get(buffer, offset + 39));
  }
  ...
  public OrderCapacity orderCapacity() {
    return OrderCapacity.get(CodecUtil.charGet(buffer, offset + 40));
  }
  ...
  public IntermarketSweepEligibility intermarketSweepEligibility() {
    return IntermarketSweepEligibility.get(CodecUtil.uint8Get(buffer, offset + 41));
  }
  ...
  public long minimumQuantity() {
    return CodecUtil.uint32Get(buffer, offset + 42, java.nio.ByteOrder.LITTLE_ENDIAN);
  }
  ...
  public CrossType crossType() {
    return CrossType.get(CodecUtil.charGet(buffer, offset + 46));
  }
  ...
  public static String CustomerTypeMetaAttribute(final MetaAttribute metaAttribute) {
    switch (metaAttribute) {
      case EPOCH:
        return "unix";
      case TIME_UNIT:
  ...
  public CustomerType customerType() {
    return CustomerType.get(CodecUtil.charGet(buffer, offset + 47));
  }
