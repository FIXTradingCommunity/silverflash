...
abstract class AbstractFlow {
  ...
  static abstract class Builder<T, B extends Builder<T, B>> implements FlowBuilder<T, B> {
    ...
    /* (non-Javadoc)
     * @see org.fixtrading.silverflash.fixp.flow.FlowBuilder#withMessageEncoder(org.fixtrading.silverflash.fixp.messages.MessageEncoder)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.fixtrading.silverflash.fixp.flow.FlowBuilder#withReactor(org.fixtrading.silverflash.reactor.EventReactor)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.fixtrading.silverflash.fixp.flow.FlowBuilder#withSequencer(org.fixtrading.silverflash.fixp.flow.Sequencer)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.fixtrading.silverflash.fixp.flow.FlowBuilder#withTransport(org.fixtrading.silverflash.transport.Transport)
     */
    @Override
