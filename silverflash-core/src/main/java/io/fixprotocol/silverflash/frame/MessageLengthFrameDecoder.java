...
public class MessageLengthFrameDecoder implements MessageFrameDecoder {
   ...
   * (non-Javadoc)
   * 
   * @see io.fixprotocol.silverflash.frame.sofh.MessageFrameDecoder#decodeFrameHeader()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see io.fixprotocol.silverflash.frame.sofh.MessageFrameDecoder#decodeFrameTrailer()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see io.fixprotocol.silverflash.frame.sofh.MessageFrameDecoder#getMessageLength()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see io.fixprotocol.silverflash.frame.sofh.MessageFrameDecoder#wrap(java.nio.ByteBuffer)
   */
  @Override
  public MessageLengthFrameDecoder wrap(ByteBuffer buffer) {
