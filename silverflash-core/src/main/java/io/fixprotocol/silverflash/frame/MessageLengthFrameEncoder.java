...
public class MessageLengthFrameEncoder implements MessageFrameEncoder {
   ...
   * (non-Javadoc)
   * 
   * @see io.fixprotocol.silverflash.buffer.MessageFrameEncoder#encodeFrameHeader()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see io.fixprotocol.silverflash.buffer.MessageFrameEncoder#encodeFrameTrailer()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see io.fixprotocol.silverflash.buffer.MessageFrameEncoder#setMessageLength(int)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see io.fixprotocol.silverflash.buffer.MessageFrameEncoder#wrap(java.nio.ByteBuffer)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see io.fixprotocol.silverflash.frame.MessageFrameEncoder#getHeaderLength()
   */
  @Override
