...
abstract class AbstractTlsChannel extends AbstractTcpChannel {
   ...
   * (non-Javadoc)
   * 
   * @see io.fixprotocol.silverflash.transport.AbstractTcpChannel#readyToRead()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see io.fixprotocol.silverflash.transport.AbstractTcpChannel#readyToWrite()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see io.fixprotocol.silverflash.transport.AbstractTcpChannel#write(java.nio.ByteBuffer[])
   */
  @Override
